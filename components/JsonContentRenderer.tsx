        ...
        return (
          ...
          >
            {section.level === 1 && (
              <h1
                id={section.id}
                className="text-4xl font-bold mt-8 mb-4 text-gray-900 scroll-mt-32"
              >
                {section.content}
              </h1>
            )}
            {section.level === 2 && (
              <h2
                id={section.id}
                className="text-3xl font-semibold mt-16 mb-4 text-gray-900 scroll-mt-32"
              >
                {section.content}
              </h2>
            )}
            {section.level === 3 && (
              <h3
                id={section.id}
                className="text-2xl font-semibold mt-4 mb-2 text-gray-900 scroll-mt-32"
              >
                {section.content}
              </h3>
            )}
            {section.level === 4 && (
              <h4
                id={section.id}
                className="text-xl font-medium mt-3 mb-2 text-gray-800"
              >
                {section.content}
              </h4>
            )}
